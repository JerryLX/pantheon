...
def main():
    ...
    if args.option == 'sender':
        ...
        # check_call(cmd)
        cmd = [send_src, "send", args.ip, args.port, "--pcc-rate-control=python -pyhelper=loaded\_client -pypath=/home/lixu/PCC-RL/src/udt-plugins/auto_testing/ --history-len=10 --pcc-utility-calc=linear --model-path=/home/lixu/PCC-RL/src/udt-plugins/auto_testing/autoxxxxpb/ --preference=0.1"]
        print (cmd)
        check_call(cmd)
        return
